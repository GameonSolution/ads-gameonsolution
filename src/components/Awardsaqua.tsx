      ...
      <div className="w-full lg:w-[80%] flex flex-col gap-10">
        ...
        <div className="w-full flex justify-center">
          <p className="text-3xl md:text-5xl font-primary uppercase text-white text-center">
            Our <span className="text-cyan-400">Awards & Features</span>
          </p>
        </div>

        {/* Sub Title */}
        <div className="w-full flex justify-center">
          <p className="text-sm md:text-base font-secondary uppercase tracking-[2px] text-cyan-400">
